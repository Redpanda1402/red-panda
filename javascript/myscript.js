...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "i miss ur smell" + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;pls lemme:';
document.querySelector('.Description .modal-body').innerHTML = 'SNIFF U <i class="fas fa-heart"></i> ';
